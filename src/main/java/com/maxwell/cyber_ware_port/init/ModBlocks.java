...
public class ModBlocks {
    ...
    public static final DeferredBlock<ComponentBoxBlock> COMPONENT_BOX = BLOCKS.register("component_box",
            (location) -> new ComponentBoxBlock(BlockBehaviour.Properties.of().setId(ResourceKey.create(Registries.BLOCK, location)).mapColor(MapColor.METAL).strength(0.4f, 6.0f).noOcclusion().requiresCorrectToolForDrops()));
