...
import com.maxwell.cyber_ware_port.common.item.*;
...
public class ModItems {
    ...
    public static final DeferredItem<BlockItem> BLUEPRINT_CHEST = ITEMS.registerSimpleBlockItem("blueprint_chest", ModBlocks.BLUEPRINT_CHEST);
    ...
    public static final DeferredHolder<Item, CyberwareItem> HUMAN_HEART = registerHumanPart("body_part_heart", BodyRegionEnum.HEART.getStartSlot(), 1, BodyPartType.HEART);
    public static final DeferredHolder<Item, CorticalStackItem> CORTICAL_STACK = ITEMS.register("brain_upgrades_cortical_stack", (location) -> new CorticalStackItem(modProps(location)));
    ...
    private static DeferredHolder<Item, CyberwareItem> registerHumanPart(String name, int slotId, int maxInstall, BodyPartType bodyPartType) {
        return ITEMS.register(name, (location) -> new CyberwareItem.Builder(modProps(location), 0, slotId)
