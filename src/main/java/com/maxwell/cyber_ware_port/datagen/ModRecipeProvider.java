...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pWriter) {
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.SURGERY_CHAMBER.get())
                ...
                .unlockedBy("has_iron", internalHas(Items.IRON_INGOT))
                .save(pWriter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.SCANNER.get())
                ...
                .define('R', Items.REDSTONE)
                .unlockedBy("has_redstone", internalHas(Items.REDSTONE))
                .save(pWriter);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.BLUEPRINT_CHEST.get())
                ...
                .unlockedBy("has_lapis", internalHas(Items.LAPIS_LAZULI))
                .save(pWriter);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.COMBAT, ModItems.KATANA.get())
                ...
                .unlockedBy("has_iron", internalHas(Items.IRON_INGOT))
                .save(pWriter);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.NEUROPOZYNE.get(), 1)
                .requires(Items.SPIDER_EYE)
                .requires(Items.SUGAR)
                .requires(Items.IRON_NUGGET)
                .unlockedBy("has_spider_eye", internalHas(Items.SPIDER_EYE))
                .save(pWriter);
        ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, ModBlocks.RADIO_TOWER_CORE.get())
                ...
                .pattern("ICI")
                .define('I', Items.IRON_INGOT)
                .define('C', ModBlocks.RADIO_TOWER_COMPONENT.get())
                .define('D', Items.DIAMOND)
                .unlockedBy("has_radio_component", internalHas(ModBlocks.RADIO_TOWER_COMPONENT.get()))
                .save(pWriter);
    ...
    private Criterion<net.minecraft.advancements.critereon.InventoryChangeTrigger.TriggerInstance> internalHas(ItemLike pItem) {
        return inventoryTrigger(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(pItem).build());
    }
