...
public class CyberWitherModel extends EntityModel<CyberWitherRenderState> {
    ...
    public static final ModelLayerLocation ARMOR_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(CyberWare.MODID, "cyber_wither"), "armor");
    ...
    public static LayerDefinition createBodyLayer(CubeDeformation deformation) {
        ...
        partdefinition.addOrReplaceChild("shoulders",
                CubeListBuilder.create().texOffs(0, 16)
                        .addBox(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, deformation), PartPose.ZERO);
        partdefinition.addOrReplaceChild("ribcage",
        ...
        partdefinition.addOrReplaceChild("center_head",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, deformation), PartPose.ZERO);
        CubeListBuilder sideHeadBuilder = CubeListBuilder.create().texOffs(32, 0)
                .addBox(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, deformation);
        partdefinition.addOrReplaceChild("right_head", sideHeadBuilder, PartPose.offset(-8.0F, 4.0F, 0.0F));
        partdefinition.addOrReplaceChild("left_head", sideHeadBuilder, PartPose.offset(10.0F, 4.0F, 0.0F));
        return LayerDefinition.create(meshdefinition, 64, 64);
    }

    private static void setupSideHeadRotation(CyberWitherRenderState state, ModelPart head, int headIndex) {
    ...
    public void setupAnim(CyberWitherRenderState state) {
        ...
        setupSideHeadRotation(state, this.rightHead, 0);
        setupSideHeadRotation(state, this.leftHead, 1);
