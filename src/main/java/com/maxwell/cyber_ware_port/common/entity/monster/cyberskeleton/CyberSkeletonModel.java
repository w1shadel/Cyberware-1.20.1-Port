...
public class CyberSkeletonModel<S extends CyberSkeletonRenderState> extends HumanoidModel<S> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(Identifier.fromNamespaceAndPath(CyberWare.MODID, "cyber_skeleton"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        root.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(40, 16).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F)
                .texOffs(44, 1).addBox(-3.0F, 5.0F, -2.0F, 6.0F, 9.0F, 4.0F)
                .texOffs(24, 0).addBox(-5.0F, 11.0F, -1.0F, 10.0F, 2.0F, 2.0F), PartPose.offset(-5.0F, 2.0F, 0.0F));
        root.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(40, 16).mirror().addBox(-1.0F, -2.0F, -1.0F, 2.0F, 12.0F, 2.0F).mirror(false)
                .texOffs(33, 6).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 7.0F, 2.0F), PartPose.offset(5.0F, 2.0F, 0.0F));
        ...
        root.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-1.0F, 0.0F, -1.0F, 2.0F, 12.0F, 2.0F).mirror(false), PartPose.offset(2.0F, 12.0F, 0.0F));
        return LayerDefinition.create(meshdefinition, 64, 32);
    }

    @Override
    public void setupAnim(CyberSkeletonRenderState state) {
