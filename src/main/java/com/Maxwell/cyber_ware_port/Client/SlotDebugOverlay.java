...
public class SlotDebugOverlay {private static final boolean ENABLE_DEBUG = false;
    ...
    public static void onScreenRenderPost(ScreenEvent.Render.Post event) {
        ...
        if (event.getScreen() instanceof AbstractContainerScreen<?> screen) {
            ...
            for (Slot slot : screen.getMenu().slots) {
                ...
                int y = guiTop + slot.y;int color = (slot.x < 0 || slot.y < 0 || slot.x > 176) ? 0x80FF0000 : 0x8000FF00;
                ...
                if (isHovering(x, y, mouseX, mouseY)) {
                    ...
                    g.renderOutline(x - 1, y - 1, 18, 18, 0xFFFFFFFF);String info1 = "Index: " + slot.index;
