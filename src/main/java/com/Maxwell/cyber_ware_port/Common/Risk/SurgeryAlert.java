package com.Maxwell.cyber_ware_port.Common.Risk;import net.minecraft.ChatFormatting;
import net.minecraft.network.chat.Component;public record SurgeryAlert(Component message, int color) {
