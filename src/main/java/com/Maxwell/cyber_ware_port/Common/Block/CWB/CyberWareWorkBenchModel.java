package com.Maxwell.cyber_ware_port.Common.Block.CWB;import com.mojang.blaze3d.vertex.PoseStack;
...
public class CyberWareWorkBenchModel extends Model {
    ...
    public void setupAnim(CyberwareWorkbenchBlockEntity pBlockEntity, float pPartialTick) {
        ...
        float initialY = -23.5F;float t1 = 0.1668F;
        float t2 = 0.6668F;float targetOffset = 6.0F;
