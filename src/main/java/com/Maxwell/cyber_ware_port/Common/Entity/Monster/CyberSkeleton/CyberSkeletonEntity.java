...
public class CyberSkeletonEntity extends Skeleton implements ICyberwareMob {
    ...
    public void aiStep() {
        ...
        double distSqr = this.distanceToSqr(target);if (!isMeleeMode && meleeCooldown == 0 && distSqr <= MELEE_TRIGGER_DIST_SQR) {
            startMeleeMode();
        }
    ...
    public boolean isMeleeMode() { return isMeleeMode; }
    public boolean isBackstepping() { return isBackstepping; }
    public void setBackstepping(boolean backstepping) { this.isBackstepping = backstepping; }
