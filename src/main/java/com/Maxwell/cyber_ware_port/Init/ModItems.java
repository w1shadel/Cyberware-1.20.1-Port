...
public class ModItems {
    ...
    public static final RegistryObject<Item> HYPER_OXYGENATION = ITEMS.register("lungs_upgrades_hyperoxygenation", HyperoxygenationBoostItem::new);
    public static final RegistryObject<Item> LIVER_FILTER = ITEMS.register("lower_organs_upgrades_liver_filter", LiverFilterItem::new);
    ...
    public static final RegistryObject<Item> CREATIVE_BATTERY = ITEMS.register("creative_battery", CreativeBatteryItem::new);
    ...
    public static final RegistryObject<Item> CRANIAL_BROADCASTER = ITEMS.register("brain_upgrades_radio", CranialBroadcasterItem::new);
    ...
    public static final RegistryObject<Item> WIRED_REFLEXES = ITEMS.register("muscle_upgrades_wired_reflexes", WiredReflexesItem::new);
    public static final RegistryObject<Item> BONELACING = ITEMS.register("bone_upgrades_bonelacing", BonelacingItem::new);
    public static final RegistryObject<Item> CORTICAL_STACK = ITEMS.register("brain_upgrades_cortical_stack", CorticalStackItem::new);
    ...
    public static final RegistryObject<Item> CARDIOVASCULAR_COUPLER = ITEMS.register("heart_upgrades_coupler", CardiovascularCouplerItem::new);
