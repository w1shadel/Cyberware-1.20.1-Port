package com.Maxwell.cyber_ware_port.Init;import com.Maxwell.cyber_ware_port.Common.Block.BlueprintChest.BlueprintChestBlock;
...
import java.util.function.Supplier;public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, CyberWare.MODID);private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block) {
        RegistryObject<T> toReturn = BLOCKS.register(name, block);registerBlockItem(name, toReturn);return toReturn;}
    ...
    public static final RegistryObject<Block> CYBER_WITHER_SKELETON_SKULL = BLOCKS.register("cyber_wither_skeleton_skull",
            ...
            () -> new RobosurgeonBlock(BlockBehaviour.Properties.of()
                    ...
                    .strength(5.0f, 6.0f)
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> SURGERY_CHAMBER = registerBlock("surgery_chamber",
            () -> new SurgeryChamberBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(4.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> RADIO_TOWER_COMPONENT = registerBlock("radio_tower_component",
            () -> new RadioTowerFenceBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(2.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> RADIO_TOWER_CORE = registerBlock("radio_tower_core",
            () -> new RadioTowerCoreBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(2.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> CYBERWARE_WORKBENCH = registerBlock("cyberware_workbench",
            () -> new CyberwareWorkbenchBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(4.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> COMPONENT_BOX = BLOCKS.register("component_box",
            () -> new ComponentBoxBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(0.4f, 6.0f)
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> SCANNER = registerBlock("scanner",
            () -> new ScannerBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(4.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> BLUEPRINT_CHEST = registerBlock("blueprint_chest",
            () -> new BlueprintChestBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(4.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static final RegistryObject<Block> RADIO_KIT_BLOCK = registerBlock("radio_kit",
            () -> new RadioKitBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.METAL)
                    .strength(2.0f, 5.0f)
                    .noOcclusion()
                    .requiresCorrectToolForDrops()));public static void register(IEventBus eventBus) {
