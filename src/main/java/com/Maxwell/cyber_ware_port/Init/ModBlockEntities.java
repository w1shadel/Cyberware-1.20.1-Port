package com.Maxwell.cyber_ware_port.Init;import com.Maxwell.cyber_ware_port.Common.Block.BlueprintChest.BlueprintChestBlockEntity;
...
import net.minecraftforge.registries.RegistryObject;public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, CyberWare.MODID);public static final RegistryObject<BlockEntityType<SurgeryChamberBlockEntity>> SURGERY_CHAMBER =
            BLOCK_ENTITIES.register("surgery_chamber",
                    () -> BlockEntityType.Builder.of(
                            SurgeryChamberBlockEntity::new,
                            ModBlocks.SURGERY_CHAMBER.get()
                    ).build(null));public static final RegistryObject<BlockEntityType<RobosurgeonBlockEntity>> ROBO_SURGEON =
            BLOCK_ENTITIES.register("robo_surgeon",
                    () -> BlockEntityType.Builder.of(
                            RobosurgeonBlockEntity::new,
                            ModBlocks.ROBO_SURGEON.get()
                    ).build(null));public static final RegistryObject<BlockEntityType<RadioTowerCoreBlockEntity>> RADIO_TOWER_CORE =
            BLOCK_ENTITIES.register("radio_tower_core",
                    () -> BlockEntityType.Builder.of(
                            RadioTowerCoreBlockEntity::new,
                            ModBlocks.RADIO_TOWER_CORE.get()
                    ).build(null));public static final RegistryObject<BlockEntityType<CyberwareWorkbenchBlockEntity>> CYBERWARE_WORKBENCH =
            BLOCK_ENTITIES.register("cyberware_workbench", () ->
                    BlockEntityType.Builder.of(CyberwareWorkbenchBlockEntity::new,
                            ModBlocks.CYBERWARE_WORKBENCH.get()).build(null));public static final RegistryObject<BlockEntityType<ComponentBoxBlockEntity>> COMPONENT_BOX =
...
public static final RegistryObject<BlockEntityType<ScannerBlockEntity>> SCANNER =
            BLOCK_ENTITIES.register("scanner", () ->
                    BlockEntityType.Builder.of(ScannerBlockEntity::new,
                            ModBlocks.SCANNER.get()).build(null));public static final RegistryObject<BlockEntityType<BlueprintChestBlockEntity>> BLUEPRINT_CHEST =
            BLOCK_ENTITIES.register("blueprint_chest", () ->
                    BlockEntityType.Builder.of(BlueprintChestBlockEntity::new,
                            ModBlocks.BLUEPRINT_CHEST.get()).build(null));public static final RegistryObject<BlockEntityType<CyberSkullBlockEntity>> CYBER_SKULL = BLOCK_ENTITIES.register("cyber_wither_skeleton_skull",
            () -> BlockEntityType.Builder.of(
