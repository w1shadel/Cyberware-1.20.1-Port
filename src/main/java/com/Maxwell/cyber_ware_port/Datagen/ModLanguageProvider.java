...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        if (locale.equals("en_us")) {
            ...
            add("cyberware.tooltip.brain_upgrades_cortical_stack", "Saves XP in a capsule upon death.");
        ...
        } else if (locale.equals("ja_jp")) {add("itemGroup.cyber_ware_port.items", "サイバーウェア");add(ModBlocks.ROBO_SURGEON.get(), "ロボ外科医");
            add(ModBlocks.SURGERY_CHAMBER.get(), "手術室");
            add(ModBlocks.CYBERWARE_WORKBENCH.get(), "サイバーウェア工作台");
            add(ModBlocks.SCANNER.get(), "スキャナー");add(ModItems.BLUEPRINT.get(), "空白の設計図");
            add(ModItems.EXP_CAPSULE.get(), "経験値カプセル");
            add(ModItems.CREATIVE_BATTERY.get(), "クリエイティブ蓄電器");add(ModItems.HUMAN_BRAIN.get(), "人間の脳");
            ...
            add(ModItems.MARROW_BATTERY.get(), "骨髄バッテリー");add(ModItems.CYBER_ARM_LEFT.get(), "左サイバーアーム");
             ...
             add(ModItems.REINFORCED_FIST.get(), "強化フィスト");add(ModItems.AQUATIC_PROPULSION.get(), "水中推進システム");
             add(ModItems.DEPLOYABLE_WHEELS.get(), "展開式ホイール");add("gui.cyber_ware_port.scanner.chance", "[%s%% の確率]");
            ...
            add("cyberware.gui.scanner_saying.73", "10万ビットコインをGOXしました");add("key.cyber_ware_port.menu", "サイバーウェアメニューを開く");
            ...
            add("cyberware_slot.cyber_ware_port.unknown", "不明");add("cyberware.tooltip.shiftPrompt", "スニークを押すと詳細");
            ...
            add("cyberware.tooltip.slot", "%s"); add("cyberware.tooltip.exp_capsule", "記録された経験値が貯められています");
            ...
            add("cyberware.tooltip.skin_upgrades_synthetic_skin", "サイバーアーム・レッグを隠します");
            add("cyberware.tooltip.skin_upgrades_immuno", "免疫システムの反応を抑制します\n病気や毒への耐性が減少します");

            add("cyberware.tooltip.muscle_upgrades_wired_reflexes", "攻撃速度が速くなります\n自動的に攻撃者の方を見ます");
            add("cyberware.tooltip.muscle_upgrades_muscle_replacements", "移動速度が速くなります\n力が上昇します");
